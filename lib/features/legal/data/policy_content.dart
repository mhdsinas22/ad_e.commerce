...
AER LLP ("AER", "we", "our", or "us") operates the AER App and the website www.aerstore.in. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our mobile application and website.
...
We collect the following information when you use our app or website.
## Personal Information
When creating an account or using services, we may collect:\n
● Full Name\n
...
If you register a warranty or book repair services:\n
● Device details\n
...
● Register and manage warranties\n
...
---
# 4. OTP Verification
For secure login and account creation, the AER App uses SMS OTP verification.
...
You may disable notifications from your device settings.

---

# 6. Payment Processing
All payments are processed securely through Razorpay.
AER does not store or process your card details such as:\n
● Card number\n
● CVV\n
● Expiry date\n

Payment data is handled directly by the payment gateway provider.
...
● SMS OTP Provider – Phone verification\n
...
The AER App is intended for users aged 13 years or older.
We do not knowingly collect personal information from children under 13.

---
# 12. Warranty Information
Warranty coverage varies depending on the product type.\n
...
""",
  ...
  static PolicyModel termsOfService = PolicyModel(
...
AER is not responsible for:\n
● Pre-existing device issues not disclosed by the user\n
...
● Abuse customer support or staff\n
...
""",
  ...
  static PolicyModel refundReturnPolicy = PolicyModel(
...
The video must:\n
● Start from opening the sealed package\n
...
Refunds will be issued through the original payment method. ''',
  ...
  static PolicyModel shippingPolicy = PolicyModel(
...
""",
  ...
  static PolicyModel warrantyPolicy = PolicyModel(
...
After verification, AER will provide further instructions.''',
  );
  static PolicyModel contactInformation = PolicyModel(
